        ...
        <div className="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div className="container py-5">
                <div className="row g-5 align-items-center">
                    ...
                    <div className="col-lg-6">
                        <h5
                            className="text text-uppercase mb-3"
                            style={{ letterSpacing: '5px', color: "pink" }}
                        >
                            About Us
                        </h5>
                        <h1 className="display-5 mb-4">We are Rotaract FST Fès</h1>
                        <p className="mb-4">
                            Le Rotaract est un réseau mondial de clubs de jeunes qui partagent
                            les mêmes valeurs : servir, apprendre et créer des liens d’amitié.
                            Chaque club a sa propre identité, mais tous font partie de cette
                            grande famille.
                        </p>
                        ...
                        <a href="/equipe" className="btn btn-primary py-3 px-5">
                            En savoir plus
                        </a>
                    </div>
                </div>
